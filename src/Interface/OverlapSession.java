 ...
 */
public class OverlapSession extends javax.swing.JFrame {
    ...
    /**
     * Creates new form OverlapSession
     */
    public OverlapSession() {
        initComponents();
        st= DBconect.connect();
        tableload();
    }
    ...
    private void initComponents() {
        ...
        oSessionTable = new javax.swing.JTable();
        ...
        oSessionTable.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        oSessionTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        oSessionTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                oSessionTableMouseClicked(evt);
            }
        });
        oSessionTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                oSessionTableKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(oSessionTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 1340, 170));
        ...
        jPanel1.add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 550, -1, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setText("Manage Overlap Session");
    ...
    public void tableload(){
        ...
        try {
            String sql = "SELECT olID AS ID,s1_lecture1 as 'Session 1 Lecturer 1' ,s1_lecture2 as 'Session 1 Lecturer 1',"
                    ...
                    + "s2_tag as 'Session 2 Tag' FROM overlap_session";
            rs = st.executeQuery(sql);
            oSessionTable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public void tabledata() {
        ...
        int r = oSessionTable.getSelectedRow();
        
        String yearAndSem = oSessionTable.getValueAt(r, 2).toString();
        String programme = oSessionTable.getValueAt(r, 3).toString();
    ...
    private void oSessionTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_oSessionTableMouseClicked
        // TODO add your handling code here:
        tabledata();
    }//GEN-LAST:event_oSessionTableMouseClicked

    private void oSessionTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_oSessionTableKeyReleased
        // TODO add your handling code here:
        tabledata();
    }//GEN-LAST:event_oSessionTableKeyReleased
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        int r = oSessionTable.getSelectedRow();
        int value = (int) (oSessionTable.getModel().getValueAt(r, 0));

        if(check == 0){

            try {
                String sql = "DELETE FROM overlap_session WHERE olID='"+value+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverlapSession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OverlapSession().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable oSessionTable;
